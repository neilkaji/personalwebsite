/* Neil Kaji site — PORTFOLIO page. The full set. */
      ...
      <main>
        <Container style={{ paddingTop: 'var(--nk-section-pad-sm, 64px)', paddingBottom: 28 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            <p className="overline" style={{ margin: 0 }}><Editable id="portfoliopage-overline" text="Portfolio" /></p>
          ...
          <p style={{ fontSize: 17, lineHeight: 1.7, color: 'var(--color-ink-secondary)', marginTop: 16, maxWidth: 600 }}>
            <Editable id="portfoliopage-intro" text="A collection of projects, experiments, and things I've made." multiline />
          </p>
        </Container>
